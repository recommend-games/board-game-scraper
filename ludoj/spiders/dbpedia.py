...
def _sparql_xpath(
    ...
    sparql_ns = sparql_ns + ':' if sparql_ns and not sparql_ns.endswith(':') else sparql_ns
...
class DBpediaSpider(Spider):
    ...
    def parse_game(self, response):
        ...
        ldr.add_xpath(
            'name', _sparql_xpath('http://www.w3.org/2000/01/rdf-schema#label', lang='en'))
        ldr.add_xpath('name', _sparql_xpath('http://xmlns.com/foaf/0.1/name', lang='en'))
        ldr.add_xpath('name', _sparql_xpath('http://dbpedia.org/property/name', lang='en'))
        ldr.add_xpath('name', _sparql_xpath('http://www.w3.org/2000/01/rdf-schema#label'))
        ...
        ldr.add_xpath('alt_name', _sparql_xpath('http://www.w3.org/2000/01/rdf-schema#label'))
        ...
        ldr.add_xpath(
            'description', _sparql_xpath('http://dbpedia.org/ontology/abstract', lang='en'))
        ldr.add_xpath(
            'description',
        ...
        ldr.add_xpath(
            'external_link',
            _sparql_xpath('http://xmlns.com/foaf/0.1/isPrimaryTopicOf', value_type='uri'))
        ldr.add_xpath(
            'external_link',
            _sparql_xpath('http://www.w3.org/2002/07/owl#sameAs', value_type='uri'))

        ldr.add_xpath('min_players', _sparql_xpath('http://dbpedia.org/property/players'))
