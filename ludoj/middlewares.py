...
class DelayedRetry:
    ...
    def from_crawler(cls, crawler):
        ...
        backoff_max_delay = settings.getfloat('DELAYED_RETRY_BACKOFF_MAX_DELAY', 10 * delay)
        ...
        return cls(http_codes, delay, times, backoff, backoff_max_delay, priority_adjust)
    ...
    def _retry(self, request):
        ...
        req.meta['retry_delay'] = min(2 * delay, self.backoff_max_delay) if self.backoff else delay
